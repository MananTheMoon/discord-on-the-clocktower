const replies: { [key: string]: string[] } = {
  ...
  deadReplies: [
    ...
    // Commented 2021-05-08  "{arg} will be missed. No by me so much, but they will be missed.",
    ...
    // Commented 2021-05-08 "Death is a construct. And it's constructed itself in the form of {arg}.",
    ...
    // Commented 2021-05-08 "{arg} didn't deserve this.",
    ...
    "Isn't it crazy how both Dick Cheney and the guy Dick Cheney shot have outlived {arg}?",
    "Isn't it crazy how both Dick Cheney and the guy Dick Cheney shot have outlived {arg}?",
    "Fun fact, posts on Parlor are known as 'parlances'. I know this, because {arg} was an active user of Parlor before they died.",
    "{arg} has died. You may remember them as the pioneer and supporter of the three state solution (they wanted a plot of land for themselves for mediating the conflict).",
  ],
  undeadReplies: [
